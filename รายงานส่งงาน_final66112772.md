...
|                           | 2.7 บันทึกแบบ Online ส่งข้อมูลขึ้น Firebase ได้สำเร็จ                                           |    ✔️    |
|                           | 2.8 ปรับค่า evidence_photo จากเครื่องเป็น null/"OFFLINE_ONLY" ก่อนส่ง Firebase                     |    ✔️    |
...
**คะแนนรวมที่คาดหวัง: 16.5 / 20.0 คะแนน**
